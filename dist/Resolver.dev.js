  ...
  Resolver.solveVelocity = function (pairs, timeScale) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      var inverseMassA = bodyA.inverseMass,
          ...
          inverseInertiaB = bodyB.inverseInertia; // resolve each contact
      ...
      for (var j = 0; j < contacts.length; j++) {
        ...
        var normalImpulse = (1 + pair.restitution) * normalVelocity,
            normalForce = Common.clamp(pair.separation + normalVelocity, 0, 1) * frictionNormalMultiplier; // coulomb friction
        ...
        var impulseY = normalY * normalImpulse + tangentY * tangentImpulse; // apply impulse from contact
