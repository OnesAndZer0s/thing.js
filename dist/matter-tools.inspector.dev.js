...
(function webpackUniversalModuleDefinition(root, factory) {
  if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object') module.exports = factory(require("matter-js"), require("matter-tools"), require("jquery"));else if (typeof define === 'function' && define.amd) define(["matter-js", "matter-tools", "jquery"], factory);else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object') exports["Inspector"] = factory(require("matter-js"), require("matter-tools"), require("jquery"));else root["MatterTools"] = root["MatterTools"] || {}, root["MatterTools"]["Inspector"] = factory(root["Matter"], root["MatterTools"], root["jQuery"]);
})(void 0, function (__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_7__) {
  return (
    /******/
    function (modules) {
      // webpackBootstrap
    ...
    function (module, exports, __webpack_require__) {
      ...
      var _initTree = function _initTree(inspector) {
        ...
        controls.worldTree.on('changed.jstree', function (event, data) {
          var selected = [],
              worldTree = controls.worldTree.data('jstree');
          if (data.action !== 'select_node') return; // defer selection update until selection has finished propagating
        ...
        $(document).on('dnd_stop.vakata', function (event, data) {
          var worldTree = controls.worldTree.data('jstree'),
              nodes = data.data.nodes; // handle drag and drop
        ...
        controls.worldTree.on('dblclick.jstree', function () {
          var worldTree = controls.worldTree.data('jstree'),
              selected = worldTree.get_selected(); // select all children of double clicked node
      ...
      var _initEngineEvents = function _initEngineEvents(inspector) {
        ...
        inspector.beforeEngineUpdate = function () {
          ...
          var mouseDelta = mousePosition.x - inspector.mousePrevPosition.x,
              ...
              delta = mouseDelta + keyDelta; // update interface when world changes
      ...
      var _copySelectedObjects = function _copySelectedObjects(inspector) {
        inspector.clipboard.length = 0; // put selected objects into clipboard
      ...
      var _pasteSelectedObjects = function _pasteSelectedObjects(inspector) {
        ...
        var objects = [],
            worldTree = inspector.controls.worldTree.data('jstree'); // copy objects in world
      ...
      var _setSelectedObjects = function _setSelectedObjects(inspector, objects) {
        ...
        for (i = 0; i < objects.length; i++) {
          ...
          if (data) {
            ...
            _addSelectedObject(inspector, data); // log selected objects to console for property inspection
      ...
      var _addNewComposite = function _addNewComposite(inspector) {
        ...
        Composite.add(inspector.root, newComposite); // move new composite to the start so that it appears top of tree
      ...
      var _exportFile = function _exportFile(inspector) {
        ...
        for (var i = 0; i < inspector.selected.length; i++) {
          var object = inspector.selected[i].data; // skip if it's already in the composite tree
          // this means orphans will be added in the root

          if (Composite.get(exportComposite, object.id, object.type)) continue;
          Composite.add(exportComposite, object); // better filename for small exports

          if (inspector.selected.length === 1) fileName = 'export-' + object.label + '-' + object.id;
        } // santise filename


        fileName = fileName.toLowerCase().replace(/[^\w\-]/g, '') + '.json'; // serialise

        var json = Serializer.serialise(inspector.serializer, exportComposite, inspector.exportIndent); // launch export download
          ...
          if (file.name.match(/\.(txt|json)$/)) {
            ...
            reader.onload = function () {
              ...
              if (importedComposite) {
                ...
                Composite.add(inspector.root, importedComposite); // move imported composite to the start so that it appears top of tree
        ...
        if (!a.jstree) {
          ...
          a.jstree = {
            ...
            _load_node: function _load_node(b, c) {
              ...
              }, this)) : "object" == _typeof(d) ? d.url ? (d = a.extend(!0, {}, d), a.isFunction(d.url) && (d.url = d.url.call(this, b)), a.isFunction(d.data) && (d.data = d.data.call(this, b)), a.ajax(d).done(a.proxy(function (d, e, g) {
                var h = g.getResponseHeader("Content-Type");
                return h && -1 !== h.indexOf("json") || "object" == _typeof(d) ? this._append_json_data(b, d, function (a) {
                  c.call(this, a);
                ...
                var f = null,
                  ...
                  var c = a.dat,
                    ...
                    o = {
                      ...
                      icon: "object" == _typeof(a) && a.icon !== b ? a.icon : !0,
                      parent: c,
                      parents: d,
                      children: [],
                      children_d: [],
            ...
            get_json: function get_json(b, c, d) {
              ...
              var e = {
                ...
                data: c && c.no_data ? !1 : a.extend(!0, {}, b.data)
                  ...
                  f,
                  g;
              if (c && c.flat ? e.parent = b.parent : e.children = [], c && c.no_state) delete e.state;else for (f in b.state) {
            ...
            create_node: function create_node(c, d, e, f, g) {
              ...
              for (h = this.get_node(d), i = [], i.push(d), i = i.concat(h.children_d), this.trigger("model", {
                nodes: i,
                parent: c.id
              }), c.children_d = c.children_d.concat(i), j = 0, k = c.parents.length; k > j; j++) {
            ...
            this.bind = function () {
              d.bind.call(this), this._data.checkbox.uto = !1, this._data.checkbox.selected = [], this.settings.checkbox.three_state && (this.settings.checkbox.cascade = "up+down+undetermined"), this.element.on("init.jstree", a.proxy(function () {
                ...
                var d = c.node,
                    ...
                    l = {};
                if (d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1), -1 !== i.indexOf("down")) for (f = 0, g = d.children_d.length; g > f; f++) {
              ...
              var e, f, g, h, i, j;
              if (!a.isArray(b) && !this.settings.checkbox.tie_selection && (j = this.get_node(b), j && j.state.loaded)) for (e = 0, f = j.children_d.length; f > e; e++) {
          ...
          a.jstree.plugins.dnd = function (b, c) {
            ...
            a.vakata.dnd = {
              ...
              _trigger: function _trigger(c, d, e) {
            ...
            this.init = function (a, b) {
              ...
              if (!e) {
                ...
                if (this._data.massload = {}, i.length) {
                  ...
                  if ("object" == _typeof(g) && g && g.url) return g = a.extend(!0, {}, g), a.isFunction(g.url) && (g.url = g.url.call(this, i)), a.isFunction(g.data) && (g.data = g.data.call(this, i)), a.ajax(g).done(a.proxy(function (a, g, h) {
                    var i, j;
                    if (a) for (i in a) {
            ...
            this.bind = function () {
              ...
              var d, e;
              if (b = this.get_node(b), b && b.children && b.children.length && (b.children.sort(a.proxy(this.settings.sort, this)), c)) for (d = 0, e = b.children_d.length; e > d; d++) {
          ...
          a.jstree.defaults.state = {
            ...
            this.init = function (c, e) {
              var f, g;
              if (e && e.types && e.types["default"]) for (f in e.types) {
              ...
              if (j === !1) return !1;
              if (a.isArray(j)) for (f = 0, g = j.length; g > f; f++) {
              ...
              if (l = this.get_node(c, !0), l && l.length && (m = l.children(".jstree-anchor")), i = c.type, j = this.get_icon(c), c.type = d, (j === !0 || !f[i] || f[i].icon !== b && j === f[i].icon) && this.set_icon(c, f[d].icon !== b ? f[d].icon : !0), f[i] && f[i].li_attr !== b && "object" == _typeof(f[i].li_attr)) for (k in f[i].li_attr) {
