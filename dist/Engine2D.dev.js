...
(function () {
  ...
  Engine.update = function (engine, delta, correction) {
    ...
    var allBodies = Composite.allBodies(world),
        ...
        allComposites = Composite.allComposites(world); // WRAP
    ...
    for (var _i = 0; _i < allBodies.length; _i += 1) {
      var bodyA = allBodies[_i],
          attractors = bodyA.attractors;

      if (attractors && attractors.length > 0) {
        for (var j = _i + 1; j < allBodies.length; j += 1) {
          var bodyB = allBodies[j];
